---
title: 'PSTAT 194CS Final Project Write-Up, Group 5, Wikipedia Animal Articles'
...
When re-ordered based on the communities from the fast_greedy community detection algorithm, we make out communities, and they seem to be centered on nodes which have high degrees. This would explain why there are so many cross community edges in the fast_greedy algorithm as mentioned above.
